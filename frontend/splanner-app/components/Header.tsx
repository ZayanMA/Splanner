...
export default function Header() {
  ...
  return (
    <Navbar fluid rounded>
        ...
        {authenticated && (
            <Button onClick={logout} aria-label="Logout" className="mr-2 dark:text-white text-black hover:bg-gray-100 bg-transparent dark:bg-transparent dark:hover:bg-gray-900">
